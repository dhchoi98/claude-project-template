...
| 도구 | 역할 | 적합한 작업 |
|------|------|------------|
| `CC` | 아키텍트 | 설계, 디자인 패턴, 멀티파일 구조 변경, 복잡한 로직, 스켈레톤/인터페이스 생성 |
| `Cursor` | 시공팀 | 구현체 채우기, 테스트 양산, 보일러플레이트, 단순 리팩토링, 문서 보강 | (Cursor+DeepSeek)
| `Any` | 무관 | 어느 도구든 가능한 작업 |

**CC 세션은 `CC`/`Any` 티켓만 클레임한다. `Cursor` 티켓은 건너뛴다.**
...
| Cursor | Cursor+DeepSeek (구현/보완 작업 도구) |
| — | 프로젝트 고유 용어를 여기에 추가 |
